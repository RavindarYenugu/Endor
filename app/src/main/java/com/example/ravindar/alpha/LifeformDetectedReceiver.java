...
public class LifeformDetectedReceiver
    ...
    public static final String ACTION_BURN = "com.example.ravindar.alpha.BURN_IT_WITH_FIRE";
    public static final String NEW_LIFEFORM = "com.example.ravindar.alpha.NEW_LIFEFORM";
